...
import com.pandora.qqmusic.MainActivity;
...
public class NotificationUtils {
    ...
    public static void startForeground(Service context) {
        ...
        String CHANNEL_NAME = "FIH Taxi Robot Channel";//Channel 名称
        //设置点击跳转页面
        ...
        builder.setSmallIcon(R.mipmap.ic_launcher)
                .setContentTitle("QQ Music Player")
                //                .setContentTitle(Utils.getAppName(this))
                .setContentText("QQ Music Player正在运行中")
